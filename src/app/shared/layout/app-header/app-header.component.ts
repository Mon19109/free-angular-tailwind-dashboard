...
private readonly titulosPaginas: Record<string, string> = {
  ...
  usuarios: 'Usuarios',
  transacciones_adquirencia: 'Transacciones Adquirencia',
  operaciones_adquirencia: 'Operaciones Adquirencia',
  transacciones_emision: 'Transacciones Emisión',
  operaciones_emision: 'Operaciones Emisión',
  tarjeta: 'Tarjeta',
