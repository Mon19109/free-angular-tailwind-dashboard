  ...
  */
  ...
  private getCommonHeaders(): HttpHeaders {
    return new HttpHeaders({
      ...
      'Authorization': 'Bearer eyJhbGciOiJIUzUxMiJ9..biMkQyPIY1Bl2OKizTvP1tQmFBo4hYw3eWQV4Z2eD-MnxKgvSPdaFA_ddT2U2M7HEhPUeQjRv3BLEJ4k5SpOOw'
    });
  }
  ...
  console.log('url',this.url);
    ...
    const httpOptions = {
      headers: new HttpHeaders({
        'Authorization': 'Basic eyJhbGciOiJIUzUxMiJ',
        'Content-Type': 'application/json'
      })
    };
  ...
  login3(credentials: LoginCredentials): Observable<UserSessionData> {
    const deviceInfo: DeviceInfo = {
      os: 'WEB',
      latitude: credentials.latitud,
      longitude: credentials.longitud
  ...
  private handleError(error: any): Observable<never> {
    ...
    console.error('Error en AuthService status:', error.status);
