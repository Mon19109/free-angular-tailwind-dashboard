...
export class UsuariosService {
  ...
  enviarFormulario(formData: FormularioData): Observable<any> {
    ...
    return this.http.get(`${this.apiAldebaran}getUsersBy?sirioId==${formData.cuenta}&type=${formData.typeSearch}&value1=${formData.value1F}&value2=${formData.value2F}&page=1&size=10`);
  }
